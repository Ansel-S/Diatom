...
use crate::{
    storage::db::Db,
    storage::vault::VaultStore,
    privacy::config::PrivacyConfig,
    privacy::fingerprint_norm::FingerprintNorm,
    engine::ghostpipe::GhostPipeConfig,
    engine::monitor::NetMonitor,
    engine::bandwidth::BandwidthLimiter,
    engine::compat::CompatStore,
    engine::plugins::PluginRegistry,
    browser::tabs::TabStore,
    browser::budget::TabBudgetConfig,
    browser::proxy::TabProxyRegistry,
    auth::totp::TotpStore,
    auth::trust::TrustStore,
...
impl AppState {
    pub fn new(data_dir: PathBuf, initial_power: crate::features::sentinel::PowerBudget) -> Result<Self> {

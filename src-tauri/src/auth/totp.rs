...
impl TotpStore {
    ...
    pub fn add(
        ...
        let entry = TotpEntry {
            ...
            secret: clean, algorithm, digits, period, domains,
            added_at: now,
        };
    ...
    pub fn add_from_uri(
        ...
        db: &crate::storage::db::Db, master_key: &[u8; 32],
    ) -> Result<TotpEntry> {
...
pub fn generate_code(secret: &str,
algorithm: TotpAlgorithm,
digits: u8,
counter: u64) -> Result<String> {,
    if algorithm == TotpAlgorithm::Steam {
